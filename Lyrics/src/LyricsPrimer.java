...
public class LyricsPrimer {
    ...
    public LyricsPrimer() {
        ...
        window.setTitle("LyricsPrimer v2.6");
        ...
        JScrollPane sourceSP = new JScrollPane(sourceText, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        JScrollPane destSP = new JScrollPane(destText, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
